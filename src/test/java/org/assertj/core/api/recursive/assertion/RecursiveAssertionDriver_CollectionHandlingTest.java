...
class RecursiveAssertionDriver_CollectionHandlingTest extends AbstractRecursiveAssertionDriverTestBase {
  ...
  void should_assert_over_collection_object_but_not_elements_when_policy_is_collection_only() {
    ...
    // THEN
    BDDAssertions.then(failedFields).containsOnly(rootFieldLocation(),
                                                  rootFieldLocation().field("collection"));
  }
  ...
  void should_assert_over_array_object_but_not_elements_when_policy_is_collection_only() {
    ...
    List<FieldLocation> failedFields = objectUnderTest.assertOverObjectGraph(failingMockPredicate, testObject);
    // THEN
    BDDAssertions.then(failedFields).containsOnly(rootFieldLocation(), rootFieldLocation().field("array"));
  }
